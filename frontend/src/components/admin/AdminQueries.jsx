...
// import React from 'react';
// import { Trash2, User, BookOpen, MessageSquare, CheckCircle2, Phone } from 'lucide-react';
// import API_URL from '../../config/api';
...
//   // RESTORED: Implementation of the delete function
//   const handleDeleteQuery = async (id) => {
...
//       <h2 className="text-xl font-bold text-[#0c2340] mb-6">Parent Desk Inbox</h2>

//       {parentQueriesDb.length === 0 ? (
//         <p className="text-slate-500 italic">No queries found.</p>
//       ) : (
//         <div className="grid gap-4">
//           {parentQueriesDb.map((query) => (
//             <div key={query.id} className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
//               <div className="flex justify-between items-start">
//                 <div>
//                   <h3 className="font-black text-lg text-[#0c2340] flex items-center gap-2">
//                     <User size={18} /> {query.sender}
//                   </h3>
                  
//                   {query.phone ? (
//                     <a 
//                       href={formatWhatsAppLink(query.phone)} 
//                       target="_blank" 
//                       rel="noopener noreferrer"
//                       className="text-[11px] font-bold text-emerald-700 mt-1 flex items-center gap-2 hover:underline hover:text-emerald-800 transition-colors"
//                     >
//                       <Phone size={13} className="text-emerald-600" /> WhatsApp: {query.phone}
//                     </a>
//                   ) : (
...
//                   <p className="text-sm font-semibold text-amber-700 mt-1 flex items-center gap-2">
//                     <BookOpen size={16} /> {query.subject}
//                   </p>
//                 </div>
...
//                     <button
//                       onClick={() => handleResolveQuery(query.id)}
//                       className="flex items-center gap-1.5 text-[10px] font-black uppercase tracking-wider bg-emerald-600 hover:bg-emerald-700 text-white px-3 py-1.5 rounded-lg transition-colors"
...
//                   )}
//                   {query.status === 'Reviewed' && (
//                     <span className="text-[9px] font-black tracking-widest uppercase px-2 py-1 rounded bg-emerald-50 text-emerald-700 border border-emerald-200">
//                       Reviewed
//                     </span>
//                   )}
//                   {/* Ensure this button calls the function properly */}
//                   <button
//                     onClick={() => handleDeleteQuery(query.id)}
...
//                   <MessageSquare size={16} className="shrink-0 text-slate-400 mt-0.5" />
//                   {query.message}
//                 </p>
//               </div>

//               <div className="mt-4 text-[10px] text-slate-400 uppercase tracking-widest font-bold">
//                 Received: {new Date(query.created_at).toLocaleString()}
//               </div>
//             </div>
//           ))}
//         </div>
